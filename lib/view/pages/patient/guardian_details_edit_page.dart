...
class GuardianDetailsEditPage extends StatelessWidget implements Validatable {
    ...
    return ScrollConfiguration(
      ...
      child: ListView(
        children: <Widget>[
              ...
              builder: (context, state) {
                return GuardianRelationshipInput(
                    BlocProvider.of<PatientDetailsEditBloc>(context)
                        .patient
                        .guardian
                        .readableRelationship, (relationShip) {
                  BlocProvider.of<PatientDetailsEditBloc>(context)
          ...
          BlocBuilder<PatientDetailsEditBloc, PatientDetailsEditState>(
            builder: (context, state) {
              return Visibility(
                visible: BlocProvider.of<PatientDetailsEditBloc>(context)
                        .patient
                        .guardian
                        .relationShip ==
                    Relationship.other,
...
class _GuardianRelationshipInputState extends State<GuardianRelationshipInput> {
  ...
  void initState() {
    ...
    _selectedIndex = relationShipList.indexWhere((element) {
      return element.toString() == widget.initialRelationship;
    });
    ...
    return BlocBuilder<ValidationBloc, ValidationState>(
      builder: (context, state) {
        return TextField(
            ...
            onChanged: (value) => BlocProvider.of<PatientDetailsEditBloc>(context)
                .patient
                .guardian
